  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value.trim() !== '') {
        ...
        if ((type === 'tel' || field.dataset.validate === 'phone') && !validators.phone(value)) {
      ...
      const observer = new IntersectionObserver(function (entries) {
        entries.forEach(function (entry) {
          if (entry.isIntersecting) {
            ...
            const delay = el.dataset.animationDelay || el.dataset.delay || '0';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '6505c690-5e66-4275-911c-964bc1783fac',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '6505c690-5e66-4275-911c-964bc1783fac';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '6505c690-5e66-4275-911c-964bc1783fac';
